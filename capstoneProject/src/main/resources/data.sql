...
(id, first_name, last_name, age, email_address, has_Made_Posts, has_Made_One_Post, has_Made_Post_Comments, 
 ...
 has_Made_One_Transcription_Comment, one_Language, preferred_Language)
VALUES
(1, 'boudica', 'iceni', 23, 'boudica.iceni@hotmail.com', true, false, false, false, true, false, true, true, false, 'ENGLISH'),
(2, 'hasdrubal', 'benes', 24, 'hasben@gmail.com', true, false, false, true, false, false, false, false, false, 'ENGLISH'),
(3, 'yanis', 'caron', 27, 'dcerv@yahoo.com', true, false, false, false, false, false, false, false, true, 'ENGLISH'),
(4, 'chantal', 'lune', 26, 'chantealalune@gmail.com', true, false, true, true, false, false, false, false, true, 'FRENCH'),
(5, 'agnes', 'winthrop', 22, 'agwin@hotmail.com', true, false, false, false, false, false, false, false, true, 'FRENCH'),
(6, 'adasse', 'dimanche', 25, 'addo@gmail.com', true, false, false, false, false, false, true, true, true, 'FRENCH'),
(7, 'vincent', 'drapeaux', 24, 'lesdrapeauxdevincent@gmail.com', true, false, false, false, false, false, false, false, false, 
	'FRENCH'),
(8, 'alfred', 'wessex', 22, 'wessexoressex@yahoo.com', true, false, false, false, true, true, true, true, true, 'ENGLISH'),
(9, 'bonjour', 'monde', 26, 'bonjourMonde@gmail.com', true, true, false, false, false, false, false, false, true, 'FRENCH');
...
has_One_Comment, deletable_By_Author, commentable_By_Author, post_Language) 
VALUES
(1, '2018-04-19', '23:30:49', 1, 1, 'It is not that the girl is unfit for everything, it is that she is not of this world.',
	'Unfit Girl', true, false, false, true, false, true, 'ENGLISH'),
...
(3, '2018-06-18', '10:00:03', 3, 3, 'Tree of Hope, Stand Firm', 'Tree', false, true, false, false, true, false, 'ENGLISH'),
(4, '2018-07-22', '04:25:38', 4, 4, 'On ne change pas une équipe qui gagne', 'Une Équipe', false, false, true, false, true,
	false, 'FRENCH'),
(5, '2018-08-15', '23:16:24', 5, 5, 'A body sees noon from his own door', 'Own Door', true, false, false, true, false, true, 
	'ENGLISH'), 
(6, '2018-09-04', '17:45:00', 6, 6, 'La vraie amitié résiste au temps, à la distance et au silence', 'L''Amitié', false, false,
	true, false, true, false, 'FRENCH'),
...
(12, '2019-03-16', '14:07:02', 4, 4, 'Écrire, c''est une façon de parler sans être interrompu.', 'Écrire des Mots', false,
	false, true, false, true, false, 'FRENCH'),
(13, '2019-04-19', '11:30:04', 5, 5, 
	'Summer afternoon, summer afternoon; to me those have always been the two most beautiful words in the English language',
	'Beautiful Words', false, false, true, false, true, false, 'ENGLISH'),
...
(17, '2019-08-23', '10:30:36', 9, 9, 'abcdéfghijklmnop', 'abcdéfgh', false, false, true, false, true, false, 'FRENCH');
...
(id, name, transcription_Date, transcription_Time, post_id, author_id, profile_id, content, has_Comments, editable_By_Author,
	has_One_Comment, deletable_By_Author, commentable_By_Author, transcription_Language)
VALUES
(1, 'Transcription of ''concerned''', '2018-12-25', '06:30:03', 2, 8, 8,
	'tu bi ˈhæpi, wi mʌst nɑt bi tu kənˈsɜrnd wɪð ˈʌðərz', true, false, true, false, true, 'ENGLISH'),
(2, 'Transcription of ''Beautiful''', '2019-01-07', '05:43:43', 8, 1, 1,
	'THIS IS NOT REALLY A TRANSCRIPTION', true, false, false, false, true, 'ENGLISH'),
(3, 'Transcription of ''Arbre''', '2019-01-01', '05:30:30', 3, 1, 1, 'Ni l''un ni l''autre', false, true, false, true, false,
		'FRENCH');
